...
from .views import ProLista_Listar, ProLista_Comprar, ProLista_Actualizador, Lista_Listar, Lista_Actualizador, Lista_Crear

app_name = 'compra'
urlpatterns = [
    path('listado/', ProLista_Listar.as_view(), name="compra_lista"),
    url(r'^listado/(?P<pk>\d+)/$', ProLista_Comprar.as_view(), name="compra_comprar"),
    ...
    url(r'^lista/crear/', Lista_Crear.as_view(), name="lista_crear"),
